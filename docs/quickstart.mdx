---
title: Quickstart
description: Install Launchpad and get first green CI quickly.
---
...
For large/high-traffic OSS repos, start with adoption profile defaults:
...
Use profile-driven rollout to avoid over-hardening on day 1:

- `baseline`: low-friction first install
- `strict`: stronger defaults after baseline stabilizes
- `hardened`: security-heavy posture for mature repos
