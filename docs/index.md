...
Use this docs set to onboard quickly, choose presets, and roll out policy-as-code.

- [Quickstart](./quickstart.md)
- [Troubleshooting](./troubleshooting.md)
- [Quality gates](./quality-gates.md)
- [Governance checklist](./governance.md)
- [Migration: v1 contract](./migrations/v1.md)
- [Deprecation policy](./policy/deprecations.md)
